...
class _BaseRoutesWidgetState extends State<BaseRoutesWidget> {
  ...
  void initState() {
    if (widget.isSearchBar) {
      controller = TextEditingController(text: widget.searchDefault ?? "");
    }
    SystemUiOverlayStyle systemUiOverlayStyle = SystemUiOverlayStyle(
      systemNavigationBarColor: themeColor.systemNavigationBarColor, //虚拟按键背景色
    );
              ...
              : AppBar(
                  systemOverlayStyle: SystemUiOverlayStyle(
                    systemNavigationBarColor:
                        themeColor.systemNavigationBarColor, //虚拟按键背景色
                  ),
                  backgroundColor: themeColor.primaryColor,
                  toolbarHeight: widget.toolBarHeight,
                  centerTitle: true,
